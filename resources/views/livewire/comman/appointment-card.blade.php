    ...
    <div class="max-w-6xl mx-auto mb-10">
        <div class="flex flex-col md:flex-row items-center justify-between border border-beige-200 bg-white rounded-2xl p-6">
            ...
            <div class="flex-shrink-0">
                <a wire:navigate  href="{{ route('book.appointment') }}" class="inline-flex items-center bg-beige-600 border-0 py-3 px-6 focus:outline-none hover:bg-beige-700 rounded-lg text-white font-medium transition-colors">
