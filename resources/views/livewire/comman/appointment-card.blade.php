...
<div class="w-full mx-auto mb-5">
    <div class="flex flex-col items-center justify-between border border-beige-200 bg-white rounded-2xl p-4 lg:p-6">
        <div class="mb-5 text-center w-full">
            ...
            <ul class="mt-3 flex flex-wrap justify-center">
                <li class="flex items-center mr-4 mb-2">
                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-green-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="text-xs lg:text-sm">Online Booking</span>
                </li>
                <li class="flex items-center mb-2">
                    <svg class="w-4 h-4 lg:w-5 lg:h-5 text-green-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="text-xs lg:text-sm">Next-Day Appointments</span>
                </li>
            </ul>
        </div>
        <div class="w-full">
