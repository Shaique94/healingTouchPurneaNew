<div class="modal fade" id="UpdateQualificationModal" tabindex="-1" aria-labelledby="UpdateQualificationModalLabel" aria-hidden="true" x-data
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg"> 
    <div class="modal-content shadow-lg border-0 rounded-4"> 
      ...
      <div class="modal-header bg-primary text-white rounded-top-4">
        <h5 class="modal-title" id="QualificationModalLabel">Update Qualification</h5>
