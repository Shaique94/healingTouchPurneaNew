...
<div>
<div>
    <div class="modal fade" id="updateDepartmentModal" tabindex="-1" aria-hidden="true"  x-data
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content shadow-lg border-0">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white"><i class="bi bi-building-fill"></i>Update Department</h5>
