<div class="modal fade" id="UpdatepatientAppointmentModal" tabindex="-1" aria-labelledby="patientAppointmentModalLabel" aria-hidden="true" x-data
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="patientAppointmentModalLabel">New Patient & Appointment</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click="update">Schedule Appointment</button>
            </div>
        </div>
    </div>
</div>