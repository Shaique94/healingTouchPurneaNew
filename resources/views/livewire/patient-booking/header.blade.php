        ...
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden lg:flex items-center space-x-1">
                ...
                <a href="{{ route('services.page') }}" 
                    class="px-4 py-2 rounded-lg text-gray-700 hover:text-sky-600 hover:bg-sky-50 transition-colors relative"
                    :class="{ 'text-sky-600 font-medium': activeSection === 'services.page' }">
                    Services
                    <span class="absolute bottom-0 left-0 h-0.5 bg-sky-500 transition-all duration-300" 
                ...
                <a href="{{ route('our.doctors') }}" 
                    class="px-4 py-2 rounded-lg text-gray-700 hover:text-sky-600 hover:bg-sky-50 transition-colors relative"
                    :class="{ 'text-sky-600 font-medium': activeSection === 'our.doctors' }">
                    Our Doctors
                    <span class="absolute bottom-0 left-0 h-0.5 bg-sky-500 transition-all duration-300" 
                ...
                <a href="{{ route('about.page') }}" 
                    class="px-4 py-2 rounded-lg text-gray-700 hover:text-sky-600 hover:bg-sky-50 transition-colors relative"
                    :class="{ 'text-sky-600 font-medium': activeSection === 'about.page' }">
                    About Us
                    <span class="absolute bottom-0 left-0 h-0.5 bg-sky-500 transition-all duration-300" 
                ...
                <a href="{{ route('careers.page') }}" 
                    class="px-4 py-2 rounded-lg text-gray-700 hover:text-sky-600 hover:bg-sky-50 transition-colors relative"
                    :class="{ 'text-sky-600 font-medium': activeSection === 'careers.page' }">
                    Careers
                    <span class="absolute bottom-0 left-0 h-0.5 bg-sky-500 transition-all duration-300" 
                ...
                <a href="{{ route('contact.page') }}" 
                    class="px-4 py-2 rounded-lg text-gray-700 hover:text-sky-600 hover:bg-sky-50 transition-colors relative"
                    :class="{ 'text-sky-600 font-medium': activeSection === 'contact.page' }">
                    Contact
                    <span class="absolute bottom-0 left-0 h-0.5 bg-sky-500 transition-all duration-300" 
...
<div 
    ...
    <nav class="container mx-auto px-6 py-4 flex flex-col divide-y divide-gray-100">
        ...
        <a href="{{ route('services.page') }}" class="py-3 flex items-center space-x-3 text-gray-700 hover:text-sky-600" @click="open = false;">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('our.doctors') }}" class="py-3 flex items-center space-x-3 text-gray-700 hover:text-sky-600" @click="open = false;">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('careers.page') }}" class="py-3 flex items-center space-x-3 text-gray-700 hover:text-sky-600" @click="open = false;">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('contact.page') }}" class="py-3 flex items-center space-x-3 text-gray-700 hover:text-sky-600" @click="open = false;">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
