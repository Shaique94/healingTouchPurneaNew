...
<section class="bg-white py-16 px-4 md:px-12 mt-10 lg:px-24 mt-20">
    ...
    <div class="max-w-6xl mx-auto mt-20 mb-16 text-center">
        ...
        <a wire:navigate  href="{{ route('contact.page') }}" class="inline-block px-8 py-3 bg-beige-600 text-white font-medium rounded-full shadow hover:bg-beige-700 transition">
            Contact Us
        </a>
    </div>
</section>
