                        ...
                        <div class="flex items-start">
                            <div class="bg-beige-100 p-3 rounded-full mr-4 flex-shrink-0">
                                <svg class="h-6 w-6 text-beige-600" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12a9.998 9.998 0 0014.49 8.73V14.9h-3.06v-2.9h3.06v-2.22c0-3.04 1.83-4.7 4.57-4.7 1.32 0 2.7.24 2.7.24v2.95h-1.52c-1.5 0-1.97.93-1.97 1.88v2.14h3.34l-.53 2.9h-2.81v5.83A10 10 0 0022 12z" />
                                </svg>
                            </div>
                            <div>
