            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-8">
                    <div class="grid sm:grid-cols-2 gap-8">
                        ...
                        <div x-data="whatsappAvailability()" x-init="init()">
                            <!-- WhatsApp Available Section -->
                            <div x-show="isAvailable" x-transition class="flex items-start">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-800 text-lg">WhatsApp</p>
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsapp_number) }}" target="_blank"
                                        class="text-green-600 font-medium text-lg hover:text-green-800 transition-colors flex items-center">
                                        {{ $whatsapp_number }}
                                    ...
                                    <p class="text-gray-500 text-sm mt-1">
                                        <span x-text="statusText">Quick chat support available from 8 AM to 8 PM IST</span>
                                    </p>
                                </div>
                            </div>
                            
                            <!-- WhatsApp Unavailable Section -->
                            <div x-show="!isAvailable" x-transition class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-red-500 text-sm mt-1">
                                        WhatsApp support is currently unavailable. Available from 8 AM to 8 PM IST.
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script>
    // Alpine.js WhatsApp Availability Component
    function whatsappAvailability() {
        return {
            isAvailable: false,
            statusText: 'Quick chat support available from 8 AM to 8 PM IST',
            ...
            checkAvailability() {
                ...
                if (this.isAvailable) {
                    this.statusText = 'Quick chat support available (Online Now) - 8 AM to 8 PM IST';
                } else {
                    this.statusText = 'WhatsApp support is currently unavailable. Available from 8 AM to 8 PM IST';
                }
            }
        }
    }
