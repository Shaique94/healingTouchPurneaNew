    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        @else
            <div class="col-span-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($jobs as $job)
                    <div class="group bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-100">
                        <!-- Header with accent bar -->
                        <div class="h-2 bg-gradient-to-r from-blue-500 to-blue-300"></div>
                        
                        <div class="p-6 flex flex-col h-full">
                            <!-- Title with hover effect -->
                            <h2 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-blue-600 transition-colors duration-200">
                                {{ $job->title }}
                            </h2>
                            ...
                            <div class="mt-auto">
                                <a wire:navigate href="{{ route('career.detail', $job->id) }}" 
                                   class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors duration-200 group/link">
                                    View Details
