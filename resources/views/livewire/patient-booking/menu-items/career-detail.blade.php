<div class="container mx-auto px-4 py-8 mt-12  md:py-12 max-w-4xl">
    <!-- Back Button -->
    <a wire:navigate  href="{{ route('careers.page') }}" class="inline-flex items-center text-beige-600 hover:text-beige-800 mb-6 transition-colors duration-300 group">
