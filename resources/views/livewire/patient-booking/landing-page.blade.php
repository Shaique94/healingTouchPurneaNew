<div>
    ...
    <section class="relative pt-28 pb-20 md:pt-36 md:pb-32 bg-gradient-to-r from-lime-50 to-amber-50 overflow-hidden">
        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
            <div class="md:w-1/2 mb-10 md:mb-0 px-6 animate-fadeIn">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-4">
                    Compassionate Healthcare <span class="text-lime-600 block mt-1">For Your Family</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button onclick="scrollToBooking()" class="group relative bg-lime-600 hover:bg-lime-700 text-white px-8 py-3.5 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl text-lg font-medium flex items-center justify-center">
                ...
                <div class="flex flex-wrap gap-6 mt-10">
                    ...
                    <div class="flex items-center">
                        <div class="bg-lime-100 p-3 rounded-full mr-3">
            ...
            <div class="md:w-1/2 relative animate-slideInRight">
                <div class="relative">
                    <div class="absolute -inset-4 bg-gradient-to-r from-lime-200 to-amber-200 rounded-full blur-lg opacity-70"></div>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <span class="text-lime-600 font-semibold text-sm uppercase tracking-wider">World-Class Medical Care</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mt-2 mb-4">Our <span class="text-lime-600">Facilities</span></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 group hover:-translate-y-1 transition-transform duration-300">
                    <div class="bg-lime-100 p-4 rounded-full inline-block mb-6 group-hover:bg-lime-200 transition-colors duration-300">
                    ...
                    <div class="mt-6 flex items-center text-lime-600 font-medium">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 group hover:-translate-y-1 transition-transform duration-300">
                    <div class="bg-amber-100 p-4 rounded-full inline-block mb-6 group-hover:bg-amber-200 transition-colors duration-300">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 group hover:-translate-y-1 transition-transform duration-300">
                    <div class="bg-blue-100 p-4 rounded-full inline-block mb-6 group-hover:bg-blue-200 transition-colors duration-300">
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <span class="text-lime-600 font-semibold text-sm uppercase tracking-wider">Patient Stories</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mt-2 mb-4">What Our <span class="text-lime-600">Patients Say</span></h2>
                <div class="w-24 h-1 bg-amber-400 mx-auto mb-6"></div>
            </div>
    ...
    <section id="about" class="py-20 bg-gradient-to-r from-lime-50 to-amber-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <span class="text-lime-600 font-semibold text-sm uppercase tracking-wider">Our Story</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mt-2 mb-4">About <span class="text-lime-600">Healing Touch Hospital</span></h2>
                <div class="w-24 h-1 bg-amber-400 mx-auto mb-6"></div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="md:w-1/2">
                    <div class="relative">
                        <div class="absolute -inset-4 bg-gradient-to-r from-amber-200 to-lime-200 rounded-xl blur-lg opacity-70 -z-10"></div>
                ...
                <div class="md:w-1/2">
                    <h3 class="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                        <span class="bg-lime-100 text-lime-600 p-2 rounded-full mr-3">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                        <span class="bg-amber-100 text-amber-600 p-2 rounded-full mr-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <ul class="space-y-4 text-gray-600">
                        <li class="flex items-start bg-white p-4 rounded-lg shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-lime-600 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script>
        function scrollToBooking() {
            // Scroll to the booking section or trigger booking modal
            // You can implement this according to your specific booking flow
