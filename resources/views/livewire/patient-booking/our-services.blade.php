            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/doctor1.png') }}" alt="Dr. Sarah Johnson" class="w-full h-full object-cover" onerror="this.src='/api/placeholder/300/300'; this.onerror=null;">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold mb-1">Dr. Sarah Johnson</h3>
                        <p class="text-blue-600 font-medium mb-2">Cardiologist</p>
                        <p class="text-gray-600 text-sm mb-4">15+ years experience specializing in interventional cardiology and heart failure management.</p>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/doctor2.jpg') }}" alt="Dr. Michael Chen" class="w-full h-full object-cover" onerror="this.src='/api/placeholder/300/300'; this.onerror=null;">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold mb-1">Dr. Michael Chen</h3>
                        <p class="text-blue-600 font-medium mb-2">Neurologist</p>
                        <p class="text-gray-600 text-sm mb-4">12+ years experience in treating neurological disorders with specialization in stroke prevention.</p>
                        <div class="flex justify-center space-x-3">
                            <a href="#" class="text-gray-400 hover:text-blue-600">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/doctor3.jpg') }}" alt="Dr. Amara Rodriguez" class="w-full h-full object-cover" onerror="this.src='/api/placeholder/300/300'; this.onerror=null;">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold mb-1">Dr. Amara Rodriguez</h3>
                        <p class="text-blue-600 font-medium mb-2">Pediatrician</p>
                        <p class="text-gray-600 text-sm mb-4">10+ years experience in providing comprehensive healthcare for children from newborns to teenagers.</p>
                        <div class="flex justify-center space-x-3">
                            <a href="#" class="text-gray-400 hover:text-blue-600">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/doctor4.png') }}" alt="Dr. Liam Patel" class="w-full h-full object-cover" onerror="this.src='/api/placeholder/300/300'; this.onerror=null;">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold mb-1">Dr. Liam Patel</h3>
                        <p class="text-blue-600 font-medium mb-2">Orthopedic Surgeon</p>
                        <p class="text-gray-600 text-sm mb-4">Expert in joint replacement surgeries with a focus on minimally invasive techniques and sports injuries.</p>
                        <div class="flex justify-center space-x-3">
                            <a href="#" class="text-gray-400 hover:text-blue-600">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
