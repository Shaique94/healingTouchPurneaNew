<div class="min-h-screen bg-gray-50">
    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-beige-600 text-white shadow-lg transform transition-transform duration-300 lg:translate-x-0 -translate-x-full z-30 " id="sidebar">
        ...
        <nav class="mt-6">
            <div class="px-4 py-3 bg-beige-700 text-white rounded mx-3">
            ...
            <div class="px-4 py-3 bg-beige-700 text-white rounded mx-3" wire:click="openAvailablityModal">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
            ...
            <div class="px-4 py-3 bg-beige-700 text-white rounded mx-3" wire:click="logout">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
    ...
    <div class="lg:ml-64 p-4 md:p-8 pt-20 lg:pt-8">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 lg:mb-8 gap-4">
            ...
            <div class="flex flex-col w-full lg:w-auto">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <span class="px-3 py-1 bg-beige-100 text-beige-700 text-xs font-semibold rounded-full">
                        {{ ucfirst($day) }}
                    </span>
                    @endforeach
                </div>
            ...
            <div class="flex flex-col md:flex-row gap-4 w-full lg:w-auto">
                <div class="relative w-full md:w-auto">
                    ...
                    <input type="text" wire:model.live="search" class="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-beige-600" placeholder="Search...">
                </div>

                <div class="hidden md:flex items-center px-4 py-2 bg-white rounded-lg shadow-sm">
                    <div class="flex items-center">
                        <img src="{{asset('storage/' . $doctor_image)}}" alt="Doctor profile" class="w-8 h-8 rounded-full mr-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
            <div class="bg-white rounded-lg shadow p-4 md:p-6 border border-gray-200">
                <div class="flex items-center">
                    <div class="p-3 rounded-full bg-beige-100 text-beige-600">
                ...
                <div class="flex items-center space-x-4 mb-4 md:mb-0 w-full md:w-auto">
                    <div class="flex space-x-3 mt-3 w-full md:w-auto">
                        <button
                            ...
                            {{ $dateFilter === now()->toDateString() ? 'bg-beige-400 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200' }}">
                            Today
                        </button>
                        ...
                        <button
                            ...
                            class="px-4 py-2 rounded-lg shadow text-sm font-medium transition duration-200 flex-1 md:flex-none text-center
                            {{ $dateFilter === now()->addDay()->toDateString() ? 'bg-beige-400 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200' }}">
                            Tomorrow
                        </button>
                    </div>
                </div>
        ...
        <!-- Appointments Table -->
        <div class="bg-white rounded-lg shadow overflow-hidden border border-gray-200" x-data="{ appointments: [] }" wire:init="">
