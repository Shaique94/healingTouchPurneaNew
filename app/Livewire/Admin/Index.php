...
class Index extends Component
{
    ...
    public function delete($id)
    {
        ...
        $this->dispatch('success', __('Appointment deleted successfully.'));
    }

    public function exportCsv()
    {
        $today = Carbon::today()->format('Y-m-d');
        return Excel::download(new AppointmentExport, 'appointments_' . $today . '.csv', \Maatwebsite\Excel\Excel::CSV);
    }
